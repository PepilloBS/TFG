...
<html>
    ...
    <!-- La principal función de esta interfaz será generar un formulario a partir del cual se registrará el facultativo -->
            ...
            <div class="panel">
                <form role="form" method="POST">
                    <?php
                        if(isset($_POST['nombre'])){
                            ...
                            if(count($errores)>0){
                                ...
                                $insertar = $conectarBD->prepare('INSERT INTO facultativo(
                    ...
                    <table>
                        ...
                        <tr><th><a href="registro.php">Registro Paciente</a></th></tr>
                    </table>
                </form>
            </div>
        </div>
