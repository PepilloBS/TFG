...
<html>
    ...
    <!-- La principal función de esta interfaz es generar un formulario que permita al paciente introducir un nuevo dato de temperatura corporal manualmente -->
    ...
    <body>
        ...
        <div class="cuerpo">
            <div class="container">
                <div class="jumbotron">
                    <h1>Introducir nuevo valor de temperatura</h1>
                </div>
            </div> 
            <div class="panel">
                <form role="form" method="POST">
                    <?php
                        if(isset($_POST['temperatura'])){
                            ...
                            if($temperatura== null){
                                array_push($errores, "Se debe introducir un valor de temperatura");
                            }

                            if($temperatura<0|| $temperatura>10000){
                            ...
                            if(count($errores)>0){
                                ...
                                $insertar = $conectarBD->prepare('INSERT INTO valortemperatura(
                                    Temperatura,Dni,Toma,Ubicacion) VALUES(
                                    :Temperatura,:Dni, :Toma, :Ubicacion)'
                                    );
                                ...
                                if($_POST['temperatura']> $lim['Limitetemperaturas']){
                                    ...
                                    $ok_m1 = $insertarnot->execute(array(
                                        ...
                                        'Texto' =>  "$nombre $apellidos ha superado el limite máximo en temperatura corporal"
                                    ));

                                }

                                if($_POST['temperatura']< $lim['Limitetemperaturai']){
                                    ...
                                    $ok_m1 = $insertarnot->execute(array(
                                        ...
                                        'Fecha' => $_POST['toma'],
                                        'Valor' => $_POST['temperatura'],
                                        'Texto' =>  "$nombre $apellidos no ha superado el limite mínimo en temperatura corporal"
                                    ));
                    ...
                    <table>
                        ...
                        <tr><th>Valor Temperatura</th><td><input type = 'text' name = 'temperatura' ></th></tr>
