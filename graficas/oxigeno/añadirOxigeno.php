...
<html>
    <head>
        ...
        <script src="../../push.js/push.min.js"></script>
          ...
          <!-- La principal función de esta interfaz es generar un formulario que permita al paciente introducir un nuevo dato de oxígeno en sangre manualmente -->
    ...
    <body>
        ...
        <div class="cuerpo">
            <div class="container">
                <div class="jumbotron">
                    <h1>Introducir nuevo valor de oxígeno</h1>
                </div>
            </div> 
            <div class="panel">
                <form role="form" method="POST">
                    <?php
                        if(isset($_POST['oxigeno'])){
                            ...
                            if($oxigeno== null){
                                array_push($errores, "Se debe introducir un valor de oxigeno");
                            }

                            if($oxigeno<0|| $oxigeno>10000){
                            ...
                            if(count($errores)>0){
                                ...
                                $insertar = $conectarBD->prepare('INSERT INTO valoroxigeno(
                                    Oxigeno,Dni,Toma,Ubicacion) VALUES(
                                    :Oxigeno,:Dni, :Toma, :Ubicacion)'
                                    );
                                ...
                                if($_POST['oxigeno']> $lim['Limiteoxigenos']){
                                    ...
                                    $ok_m1 = $insertarnot->execute(array(
                                        ...
                                        'Fecha' => $_POST['toma'],
                                        'Valor' => $oxigeno,
                                        'Texto' =>  "$nombre $apellidos ha superado el limite máximo en oxígeno en sangre"
                                    ));

                                }

                                if($_POST['oxigeno']< $lim['Limiteoxigenoi']){
                                    ...
                                    $ok_m1 = $insertarnot->execute(array(
                                        ...
                                        'Fecha' => $_POST['toma'],
                                        'Valor' => $oxigeno,
                                        'Texto' =>  "$nombre $apellidos no ha superado el limite mínimo en oxígeno en sangre"
                                    ));
                    ...
                    <table>
                        ...
                        <tr><th>Valor Oxígeno</th><td><input type = 'text' name = 'oxigeno' ></th></tr>
